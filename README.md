...
leaving room for 2 short ones — 3 total — and a second 20k prompt is shed.
...
| **Best within SLO** | 6 | **295–332 tok/s** | 471 in / 256 out, p95 TTFT 1,005–1,135 ms, +24–33% margin |
| **Under deep chassis heat-soak** | 4 | 188 tok/s | Same shape; card idled at ~78 °C before the run. The SLO ceiling drops to 4 in this state — the range is thermal, not noise |
| Single stream | 1 | 59–89 tok/s | Same shape; the spread is thermal |
